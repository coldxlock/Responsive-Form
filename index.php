            ...
            <form action="salvar.php" method="post">
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <label class="container-radio">
                            SIM
                            <input type="radio"  id="teste1" name="pergunta1" required value="sim">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container-radio">
                            NÃO
                            <input type="radio" id="teste2" name="pergunta1" value="nao">
                            <span class="checkmark"></span>
                        </label>
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <label class="container-radio">
                            SIM
                            <input type="radio"  name="pergunta2" required value="sim">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container-radio">
                            NÃO
                            <input type="radio" name="pergunta2" value="nao">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <label class="container-radio">
                            SIM
                            <input type="radio"  name="pergunta4"  required value="sim">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container-radio">
                            NÃO
                            <input type="radio" name="pergunta4" value="nao">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>            
                <div class="row">
                    <div class="column">
                        ...
                        <label class="container-radio">
                            SIM
                            <input type="radio"  name="pergunta5"  required value="sim">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container-radio">
                            NÃO
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <label class="container-radio">
                            SATISFATÓRIA
                            <input type="radio"  name="pergunta6"  required value="satisfatorio">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container-radio">
                            NÃO SATISFATÓRIA
                            <input type="radio" name="pergunta6" value="nao-satisfatorio">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>
